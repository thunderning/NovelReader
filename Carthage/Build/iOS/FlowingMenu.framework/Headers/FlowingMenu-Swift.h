...
SWIFT_MODULE_NAMESPACE_PUSH("FlowingMenu")

/// The <code>FlowingMenuTransitionManager</code> is a concrete subclass of
/// <code>UIPercentDrivenInteractiveTransition</code> which aims to drive the transition between
/// two views by providing an flowing/elastic and bouncing animation effect.
/// You must adopt the <code>FlowingMenuDelegate</code> if you want to make the transition
/// interactive.
SWIFT_CLASS("_TtC11FlowingMenu28FlowingMenuTransitionManager")
...
@interface FlowingMenuTransitionManager (SWIFT_EXTENSION(FlowingMenu)) <UIViewControllerAnimatedTransitioning>
...
@interface FlowingMenuTransitionManager (SWIFT_EXTENSION(FlowingMenu)) <UIViewControllerTransitioningDelegate>
...
@interface FlowingMenuTransitionManager (SWIFT_EXTENSION(FlowingMenu))
/// Defines the given view as interactive to present the menu.
/// \param view The view used to respond to the gesture events.
///
- (void)setInteractivePresentationView:(UIView * _Nonnull)view SWIFT_DEPRECATED_OBJC("Swift method 'FlowingMenuTransitionManager.setInteractivePresentationView(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
/// Defines the given view as interactive to dismiss the menu.
/// \param view The view used to respond to the gesture events.
///
- (void)setInteractiveDismissView:(UIView * _Nonnull)view SWIFT_DEPRECATED_OBJC("Swift method 'FlowingMenuTransitionManager.setInteractiveDismissView(_:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
